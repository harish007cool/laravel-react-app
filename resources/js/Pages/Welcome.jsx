...
export default function Welcome({ auth }) {
    ...
    const images = [
        ...
        "https://allinoneslider.com/wp-content/uploads/2019/06/all-in-one-slider-simple-full-width-3.jpg",
        "https://allinoneslider.com/wp-content/uploads/2019/06/all-in-one-slider-simple-full-width-1.jpg",
        "https://wowslider.com/sliders/demo-10/data/images/autumn_leaves.jpg",
        "https://allinoneslider.com/wp-content/uploads/2019/06/all-in-one-slider-simple-full-width-3.jpg",
        "https://allinoneslider.com/wp-content/uploads/2019/06/all-in-one-slider-simple-full-width-1.jpg",
    ...
    // <div className="relative w-full dynamic-margin">
    // {/* Images */}
    ...
    return (
        <GuestLayout auth={auth}>
            ...
            <div className="w-full mx-auto">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center bg-black bg-opacity-50 text-white p-6 h-[701px]">
                ...
                <div className="flex justify-center space-x-2 mt-4">
                    {images.map((image, index) => (
                        <button
                            ...
                            className={`border rounded-md overflow-hidden w-20 h-10 ${index === currentIndex ? "border-blue-500" : "border-gray-300"
                                }`}
                        >
                            <img
                                src={image}
